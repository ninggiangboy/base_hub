package dev.ngb.base_hub.infrastructure.spring_config.kafka;
...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerFactoryJson(
            ConsumerFactory<String, Object> consumerFactoryJson
    ) {
